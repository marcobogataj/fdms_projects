function [motori] = DB_Mot1()
%data base motori prova

motori(1) = struct('Codice','b61.1.30', 'CN', 1.2, 'Jm',  9e-5, 'nMAX', 3000,'Cm_max',3.9);
motori(2) = struct('Codice','b61.1.60', 'CN', 1.05, 'Jm', 9e-5, 'nMAX', 6000,'Cm_max',3.9);

motori(3) = struct('Codice','b61.2.30', 'CN', 2.2, 'Jm',  1.65e-4, 'nMAX', 3000,'Cm_max',7.5);
motori(4) = struct('Codice','b61.2.60', 'CN', 1.8, 'Jm',  1.65e-4, 'nMAX', 6000,'Cm_max',7.5);

motori(5) = struct('Codice','b61.3.30', 'CN', 3.1, 'Jm',  2.35e-4, 'nMAX',  3000,'Cm_max',10.8);
motori(6) = struct('Codice','b61.3.60', 'CN', 2.3, 'Jm',  2.35e-4, 'nMAX', 6000,'Cm_max',10.8);
%% MOTORI BONFIGLIOLI
...
% 
% motori(8)=struct('Codice','BMD_{102-7.7}','Jm',4.7e-04,'CN',7.7,'Cm_max',2.5*7.7,'nMAX',4500);
% 
% motori(9)=struct('Codice','BMD_{102-8.5}','Jm',4.7e-04,'CN',8.5,'Cm_max',2.5*8.5,'nMAX',3000);
% 
% motori(10)=struct('Codice','BMD_{102-9.2}','Jm',4.7e-04,'CN',9.2,'Cm_max',2.5*9.2,'nMAX',1600);
% 
% motori(11)=struct('Codice','BMD_{102-6.5}','Jm',17.6e-04,'CN',6.5,'Cm_max',2.5*6.5,'nMAX',6000);
% 
% motori(12)=struct('Codice','BMD_{102-15}','Jm',17.6e-04,'CN',15,'Cm_max',2.5*15,'nMAX',5500);
% 
% motori(13)=struct('Codice','BMD_{102-17}','Jm',17.6e-04,'CN',17,'Cm_max',2.5*17,'nMAX',4500);
% 
% motori(14)=struct('Codice','BMD_{102-19.2}','Jm',17.6e-04,'CN',19.2,'Cm_max',2.5*19.2,'nMAX',3000);
% 
% motori(15)=struct('Codice','BMD_{102-20.7}','Jm',17.6e-04,'CN',20.7,'Cm_max',2.5*20.7,'nMAX',1600);
